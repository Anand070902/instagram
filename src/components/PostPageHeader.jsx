...
import { AppBar, Box, Container, IconButton, InputAdornment,Input, Toolbar, Typography } from '@mui/material'
            ...
            <Container>
                <Toolbar>
                    ...
                    <Box sx={{flex:1}}>
                        ...
                        <IconButton>
                            <img style={{borderRadius:"50%",outline:"1px solid #ddd"}} src="assets/homepage/a.jpg" width="40px" height="40px" alt="" />
                        </IconButton>
                    </Box>
                </Toolbar>
            </Container>
